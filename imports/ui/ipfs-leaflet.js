...
prepareIpfsCall = function(){
  ...
  callIpfs(startDate,endDate);
}

callIpfs = function(startDate,endDate){
      //test IPFS
    console.log("callIpfs")
    ...
    $.ajax({
      ...
      let obj = yearlyIpfsVals(d,startDate,endDate);
      console.log(obj)
      // updateMonths(obj);
      // calcPct(obj);
...
function yearlyIpfsVals (a,startDate,endDate){
  ...
  console.log("ipfs data",con,data)
